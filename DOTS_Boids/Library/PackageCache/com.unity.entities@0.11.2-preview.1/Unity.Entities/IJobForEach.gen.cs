...
namespace Unity.Entities
{
    ...
    public static partial class JobForEachExtensions
    {
            ...
            where T : struct, IBaseJobForEach
        {
            var typeT = typeof(T);
            if (typeof(IBaseJobForEach_C).IsAssignableFrom(typeT))
                return ScheduleInternal_C(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EC).IsAssignableFrom(typeT))
                return ScheduleInternal_EC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_B).IsAssignableFrom(typeT))
                return ScheduleInternal_B(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EB).IsAssignableFrom(typeT))
                return ScheduleInternal_EB(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_CC).IsAssignableFrom(typeT))
                return ScheduleInternal_CC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_ECC).IsAssignableFrom(typeT))
                return ScheduleInternal_ECC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BC).IsAssignableFrom(typeT))
                return ScheduleInternal_BC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BB).IsAssignableFrom(typeT))
                return ScheduleInternal_BB(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBB).IsAssignableFrom(typeT))
                return ScheduleInternal_EBB(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_CCC).IsAssignableFrom(typeT))
                return ScheduleInternal_CCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_ECCC).IsAssignableFrom(typeT))
                return ScheduleInternal_ECCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBB).IsAssignableFrom(typeT))
                return ScheduleInternal_BBB(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBB(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_CCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_CCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_ECCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_ECCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBB(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBB(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_CCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_CCCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_ECCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_ECCCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BCCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBCCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBBC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBBC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBBB(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBBB(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_CCCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_CCCCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_ECCCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_ECCCCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BCCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BCCCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBCCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBCCCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBCCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBCCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBCCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBBCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBBCC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBBBC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBBBC(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBBBB(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBBBB(ref jobData, system, default, -1, dependsOn, ScheduleMode.Run);
            throw new System.ArgumentException("Not supported");
        }
            ...
            where T : struct, IBaseJobForEach
        {
            var typeT = typeof(T);
            if (typeof(IBaseJobForEach_C).IsAssignableFrom(typeT))
                return ScheduleInternal_C(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EC).IsAssignableFrom(typeT))
                return ScheduleInternal_EC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_B).IsAssignableFrom(typeT))
                return ScheduleInternal_B(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EB).IsAssignableFrom(typeT))
                return ScheduleInternal_EB(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_CC).IsAssignableFrom(typeT))
                return ScheduleInternal_CC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_ECC).IsAssignableFrom(typeT))
                return ScheduleInternal_ECC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BC).IsAssignableFrom(typeT))
                return ScheduleInternal_BC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BB).IsAssignableFrom(typeT))
                return ScheduleInternal_BB(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBB).IsAssignableFrom(typeT))
                return ScheduleInternal_EBB(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_CCC).IsAssignableFrom(typeT))
                return ScheduleInternal_CCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_ECCC).IsAssignableFrom(typeT))
                return ScheduleInternal_ECCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBB).IsAssignableFrom(typeT))
                return ScheduleInternal_BBB(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBB(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_CCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_CCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_ECCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_ECCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBB(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBB(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_CCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_CCCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_ECCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_ECCCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BCCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBCCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBBC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBBC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBBB(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBBB(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_CCCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_CCCCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_ECCCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_ECCCCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BCCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BCCCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBCCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBCCCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBCCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBCCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBCCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBCCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBCCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBBCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBBCC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBBCC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBBBC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBBBC).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBBBC(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_BBBBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_BBBBBB(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            if (typeof(IBaseJobForEach_EBBBBBB).IsAssignableFrom(typeT))
                return ScheduleInternal_EBBBBBB(ref jobData, default, query, -1, dependsOn, ScheduleMode.Run);
            throw new System.ArgumentException("Not supported");
        }
...
#pragma warning disable 618
            ...
            where T : struct
        {
            ...
            var prefilterHandle = ChunkIterationUtility.PreparePrefilteredChunkLists(unfilteredChunkCount, queryImpl->_QueryData->MatchingArchetypes, queryImpl->_Filter, dependsOn, mode, out fullData.PrefilterData, out var deferredCountData);
